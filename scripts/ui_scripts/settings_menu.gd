...
@onready var res_menu: OptionButton = $MarginContainer/CenterContainer/VBoxContainer/MarginContainer3/HBoxContainer/Resolution
@onready var res_check: CheckButton = $MarginContainer/CenterContainer/VBoxContainer/MarginContainer4/HBoxContainer/CheckButton
